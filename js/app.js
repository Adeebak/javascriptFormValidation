...
const checkUsername = () => {
    ...
    if (!isRequired(username)){
        ...
        showError(usernameEl, ` Usename must be between ${min} and ${max} characters. `);
    }else {
...
togglePassword.addEventListener("click", function () {
    togglePasswordVisibility(passwordEl,this);
});

togglePasswordConfirm.addEventListener("click", function () {
    togglePasswordVisibility(confirmPasswordEl,this);
});
